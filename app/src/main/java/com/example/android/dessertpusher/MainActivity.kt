...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onStart() {
        super.onStart()
        Log.d(this@MainActivity.javaClass.simpleName, "onStart: ");
        timer.startTimer()
    }

    override fun onResume() {
        super.onResume()
        Log.d(this@MainActivity.javaClass.simpleName, "onResume: ");
    }

    override fun onStop() {
        super.onStop()
        Log.d(this@MainActivity.javaClass.simpleName, "onStop: ");
        timer.stopTimer()
    }

    override fun onPause() {
        super.onPause()
        Log.d(this@MainActivity.javaClass.simpleName, "onPause: ");
    }
